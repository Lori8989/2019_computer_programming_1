...
void reverse(Node** head, int dest1, int dest2){ // reverse <dest1> <dest2>
    ...
    if(dest1 < dest2){
        ...
        // for(int p = i, q = j; p < q; p++, q--){
            char tempColor[10] = {0};
        //     // printf("[%d]:%s [%d]:%s ():%s\n", p, dest1Node->color, q, dest2Node->color, tempColor);
            strncpy(tempColor, dest1Node->color, 10);
            strncpy(dest1Node->color, dest2Node->color, 10);
            strncpy(dest2Node->color, tempColor, 10);
        //     // printf("[%d]:%s [%d]:%s ():%s\n", p, dest1Node->color, q, dest2Node->color, tempColor);
        //     dest1Node = dest1Node->next;
        //     dest1Node = dest1Node->;
        // }
